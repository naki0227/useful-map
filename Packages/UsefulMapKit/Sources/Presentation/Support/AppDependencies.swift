...
public enum A11y {
    ...
    public static let draftOrigin = "draft.origin"
    public static let timeCondition = "time.condition"
    public static let timePreferencePicker = "time.preference"
    public static let datePicker = "time.date"
